...
const L = {
  ar:{
    dir:'rtl',
    /* ===== الجملة ===== */
    pieces:'قطعة',models:'الموديلات',perPiece:'سعر القطعة',modelTotal:'إجمالي الموديل',
    sizesIncluded:'القياسات المشمولة',addModel:'أضف الموديل كاملاً',inCart:'في السلة ✓',
    notEligible:'هذا الموديل غير متاح للجملة',minModelsHint:'أضف {n} موديل للوصول للحد الأدنى',
    copySuccess:'تم نسخ الطلب ✓',copyFail:'تعذّر النسخ',
    ...
    sub:'مجموع البضاعة',ship:'تكلفة النقل',tot:'المجموع النهائي',subDisc:'بعد الخصم 40%',
...
'🌙 الإعدادات\n• غيّر اللغة (عربي / English / کوردی) من أزرار اللغة في الهيدر\n• فعّل الوضع الداكن 🌙 من الزر بجانب اللغة\n• اسحب الصفحة للأسفل لتحديث المنتجات\n• يمكن تثبيت المتجر كتطبيق على هاتفك!'
  ...
  en:{
    dir:'ltr',
    /* ===== Wholesale ===== */
    pieces:'pcs',models:'Models',perPiece:'Unit price',modelTotal:'Model total',
    sizesIncluded:'Sizes included',addModel:'Add full model',inCart:'In cart ✓',
    notEligible:'This model is not available for wholesale',minModelsHint:'Add {n} more model(s) to reach the minimum',
    copySuccess:'Order copied ✓',copyFail:'Copy failed',
...
'🌙 Settings\n• Change the language (عربي / English / کوردی) from the language buttons in the header\n• Enable dark mode 🌙 from the button next to the language\n• Pull the page down to refresh products\n• You can install the store as an app on your phone!'
  ...
  ku:{
    dir:'rtl',
    /* ===== کۆمەڵ ===== */
    pieces:'دانە',models:'مۆدێلەکان',perPiece:'نرخی دانە',modelTotal:'کۆی مۆدێل',
    sizesIncluded:'قەبارە لەخۆگرتووەکان',addModel:'مۆدێلی تەواو زیاد بکە',inCart:'لە سەبەتەدا ✓',
    notEligible:'ئەم مۆدێلە بۆ کۆمەڵ بەردەست نییە',minModelsHint:'{n} مۆدێلی تر زیاد بکە',
    copySuccess:'داواکاری کۆپی کرا ✓',copyFail:'کۆپیکردن سەرکەوتوو نەبوو',
    ...
    sub:'کۆی کاڵا',ship:'کرێی گواستنەوە',tot:'کۆی گشتی کۆتایی',subDisc:'دوای داشکاندنی ٪٤٠',
